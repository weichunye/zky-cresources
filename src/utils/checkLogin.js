 ...
 * */
export function Passport(option){
  ...
  this.checkAndLogin=function(returnUrl, params){
    ...
    self.checkLogin(function(flag){
      ...
      if(flag){
        ...
        console.log("sessionStorage.getItem('ifLocation')",sessionStorage.getItem('ifLocation'))
        if(!sessionStorage.getItem('ifLocation')){
          ...
          /*window.location.href=window.SITE_CONFIG['apiURL'] + '/haoweb/web/auth/login'*/
           /*window.location.href="http://passport.escience.cn/login?WebServerURL=http//www.scihub.cstcloud.cn/haoweb/web/auth/callback&target=none&appname=dct&theme=ddl"*/
